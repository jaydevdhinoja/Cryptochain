...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and has multiple blocks', () =>{
            beforeEach(() => {
                ...
                blockchain.addBlock({ data: 'Whisky'});
                blockchain.addBlock({ data: 'Vodka'});
            })
            ...
            describe('and a chain contains a block with jumped difficulty', () => {
                it('returns false', () => {
    ...
    describe('replaceChain', () => {
        ...
        describe('when the new chain is longer', () => {
            beforeEach(() => {
                newBlockchain.addBlock({ data: 'Beers'});
                newBlockchain.addBlock({ data: 'Whisky'});
                newBlockchain.addBlock({ data: 'Vodka'});
            })
